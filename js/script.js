$(function () {
	...
	function initPlayer() {
		...
		if (!urlParams.has('id')) window.location.replace('404.html');
		
		songId = urlParams.get('id').toLowerCase();
		
		if (!(songId in _albums)) window.location.replace('404.html');
